        ...
        <div class="row">
            <div class="col-sm-4 page-sidebar" >
                ...
                <ul>
                    ...
                    <li><strong><a href="adminBanned.php" style="color:#f3b400;">Banned Users</a></strong></li>
                    <li><a href="adminSearch.php">Search</a></li>
                </ul>
            </div>
            <div class="col-sm-8">
                <h3>Temporarily Banned Users</h3>
                <p>
                <table>
                <?php 
                    $getUsers = "select * from users where ban_status=\"banned\";";
                    $usersResult = $conn->query($getUsers);
                    if(mysqli_num_rows($usersResult)==0) {
                        print "No users are currently banned temporarily";
                    } else {
                ...
                <h3>Permanently Banned Users</h3>
                <p style="color:#f1b522;">
                <strong>Note: Un-doing a perma-ban will reset the ban count for the user to 0. Perma ban = 3 temporary bans.</strong>
                <table>
                <?php 
                    $getUsers = "select * from users where ban_status=\"perma-banned\";";
                    $usersResult = $conn->query($getUsers);
                    if(mysqli_num_rows($usersResult)==0) {
                        print "No users are permanently banned.";
                    } else {
                        getUserDetails($usersResult);
                    }
                ?>
