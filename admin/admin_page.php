    ...
    <div class="container sidebar">
        <div class="row">
            <div class="col-sm-4 page-sidebar" >
                ...
                <ul>
                    <li><strong><a href="admin_page.php" style="color:#f3b400;">All Users</a></strong></li>
            ...
            <div class="col-sm-8">
                ...
                Click on the user's name to be taken to their profile where you can make edits.<br>
                <strong>Note: Un-doing a perma-ban will reset the ban count for the user to 0. Perma ban = 3 temporary bans.</strong>
                <table>
                <?php 
                    $getUsers = "select * from users where user_id != $uid;";
