    ...
    <div class="container sidebar">
        <div class="row">
            <div class="col-sm-4 page-sidebar" >
                ...
                <ul>
                    <li><strong><a href="connections_page.php" style="color:#f3b400;">All Users</a></strong></li>
            ...
            <div class="col-sm-8">
                ...
                $getUsers = "select * from users where ban_status !='perma-banned' and user_id != $uid;";
                $usersResult = $conn->query($getUsers);
                if(mysqli_num_rows($usersResult) > 0) {
                    getUserDetails($usersResult);
                } else {
                    print "There are no other users registered on the site";
                }
                ?>
                </table>
                </p>
